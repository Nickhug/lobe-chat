...
ARG USE_CN_MIRROR
ARG NEXT_PUBLIC_APP_NAME="Propert AI"
...
ENV NEXT_PUBLIC_SERVICE_MODE="${NEXT_PUBLIC_SERVICE_MODE:-server}" \
    ...
    NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY="${NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:-pk_test_b24tc2xvdGgtOTYuY2xlcmsuYWNjb3VudHMuZGV2JA}" \
    CLERK_SECRET_KEY="${CLERK_SECRET_KEY:-sk_test_zDm3bIend89vdYKKMCc4BEfDYmMClZeZuIKhjbBe1C}" \
    CLERK_WEBHOOK_SECRET="${CLERK_WEBHOOK_SECRET:-whsec_4fAdDDs4ZeMl4qRYe/dab6cNMn8Gy/k6}" \
...
ENV ACCESS_CODE="" \
    APP_URL="" \
    API_KEY_SELECT_MODE="" \
    DEFAULT_AGENT_CONFIG="model=gpt-4o;provider=openai;params.temperature=0.7;chatConfig.enableAutoCreateTopic=true;chatConfig.historyCount=10;systemRole=$$(cat /app/system_role.txt)" \
...
ENV NEXT_AUTH_SECRET="" \
    ...
    NEXTAUTH_URL="" \
    NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY="pk_test_b24tc2xvdGgtOTYuY2xlcmsuYWNjb3VudHMuZGV2JA" \
    CLERK_SECRET_KEY="sk_test_zDm3bIend89vdYKKMCc4BEfDYmMClZeZuIKhjbBe1C" \
    NEXT_PUBLIC_ENABLE_NEXT_AUTH="0" \
    CLERK_WEBHOOK_SECRET="whsec_4fAdDDs4ZeMl4qRYe/dab6cNMn8Gy/k6"
