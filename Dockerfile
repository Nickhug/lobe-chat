...
# For development mode, we'll use the builder stage directly
EXPOSE 3000
...
# The following stages are commented out for development mode
# Uncomment these stages when reverting to production mode
