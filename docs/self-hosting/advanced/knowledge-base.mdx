...
- **Options**: support model provider list: zhipu/github/openai/bedrock/ollama/google
...
# Ollama embedding (requires Ollama setup)
DEFAULT_FILES_CONFIG=embedding_model=ollama/llama2
```
